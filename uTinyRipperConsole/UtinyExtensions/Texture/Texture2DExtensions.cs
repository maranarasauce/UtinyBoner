...
using uTinyRipperConsole.TextureContainers.DDS;
using uTinyRipperConsole.TextureContainers.KTX;
using uTinyRipperConsole.TextureContainers.PVR;

using KTXFormat = uTinyRipperConsole.TextureContainers.KTX.KTXInternalFormat;
using KTXBaseFormat = uTinyRipperConsole.TextureContainers.KTX.KTXBaseInternalFormat;
using PVRFormat = uTinyRipperConsole.TextureContainers.PVR.PVRPixelFormat;

namespace uTinyRipperConsole.Exporters
{
